...
The cycle-averaged coupling strengths $\bar{g}_f(r)$ are defined via the phase-window integral in Section~\ref{sec:phase-windows} of Chapter~\ref{ch:fundamental-forces}. Particle-detection rate in channel $f$ is proportional to $\bar{g}_f(r)$; the force-quadrant assignments and $r$-dependence of each coupling are summarised in Section~\ref{sec:force-hierarchy} of that chapter.
