...
In EMTS, each quark carries a mass-energy vector $z_q = m_q + i E_q$ as before.  But it also carries an \emph{internal color phase} $\phi_c$, which we treat as an additional angular degree of freedom orthogonal to the $\theta = \omega t$ phase of the EMTS plane.  We write the full quark state schematically as
\[
