...
The modulus and argument were defined in the core framework as:
\[
r = \sqrt{m^2 + E^2}, \qquad \theta = \arctan\!\left(\frac{E}{m}\right).
\]

In units where $c=1$, or more generally $r = \sqrt{(mc^2)^2 + E^2}$ and $\theta = \arctan(E/mc^2)$.
